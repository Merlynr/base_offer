import sys
import json
sys.path.append("E:\\project\\base_offer\\leetcode\\js\\cn\\Python3")
sys.path.append("E:\\project\\base_offer\\leetcode\\js")
a = __import__('113_路径总和 II')
class TreeNode:
...
arr=json.loads("[[[5,4,8,11,null,13,4,7,2,null,null,5,1],22],[[1,2,3],5],[[1,2],0]]")
for i in range(len(arr)):
    unitArgs=arr[i]
    s=a.Solution()
    arg0 =parseTreeNode(unitArgs[0])
    arg1 = unitArgs[1]
    result=s.pathSum(arg0,arg1)
